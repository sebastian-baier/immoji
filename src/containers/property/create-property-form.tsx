...
const schema = z.object({
	...
	type: z.enum(
		[PropertyTypes.APARTMENT, PropertyTypes.HOUSE, PropertyTypes.GARAGE],
		{
	...
	const onSubmit = async (data: any) => {
		try {
			...
			const errorMessage =
				...
				error.message ||
				'Fehler beim Erstellen der Immobilie.';
	...
	return (
		<form className='flex flex-col gap-4' onSubmit={handleSubmit(onSubmit)}>
			...
			<div className='grid grid-cols-2 grid-rows-3 gap-4'>
				<div className='flex flex-col gap-1 min-h-20 justify-end'>
					{errors.address && (
				...
				<div className='flex flex-col gap-1 min-h-20 justify-end'>
					...
					>
						...
						<SelectContent>
							<SelectItem value={PropertyTypes.APARTMENT}>
								Wohnung
							</SelectItem>
							<SelectItem value={PropertyTypes.HOUSE}>
								Haus
							</SelectItem>
							<SelectItem value={PropertyTypes.GARAGE}>
								Garage
							</SelectItem>
						</SelectContent>
					</Select>
